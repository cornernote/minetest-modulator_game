...
minetest.register_on_generated(function(minp, maxp, seed)
	...
	generate("harvest:corn_wild", {"default:dirt_with_grass"}, minp, maxp, -10, 60, 8, 10, {"default:water_source"},0,{""})
	...
	generate("harvest:poppy_wild", {"defaultw:desert_sand"}, minp, maxp, -10, 20, 4, 10, {"default:water_source"},0,{""})
